...
namespace PrintLogic
{
    public class Print
    {
            ...
            double? WEIGHT, double? LENGTH, double? WIDTH, double? YIELD)
        {
            ...
            ZPLString += "^FO450,750^ADB,36,20^FDCURRENT LENGTH: ^FS"; //SEND TEXT OBJECT
            //ADD DATA FIELDS
            ZPLString += "^FO50,50^ADB,54,40^FD" + ID + "^FS"; //SEND TEXT OBJECT
            ZPLString += "^FO150,800^ADB,36,20^FD" + GAUGE + "^FS"; //SEND TEXT OBJECT
            ZPLString += "^FO150,425^ADB,36,20^FD" + THICK + "^FS"; //SEND TEXT OBJECT
            ...
            ZPLString += "^FO350,750^ADB,36,20^FD" + WIDTH + "^FS"; //SEND TEXT OBJECT
            ZPLString += "^FO350,50^ADB,36,20^FD" + YIELD + "^FS"; //SEND TEXT OBJECT
            ZPLString += "^FO450,650^ADB,36,20^FD" + LENGTH + "^FS"; //SEND TEXT OBJECT
            //ADD QR CODE
